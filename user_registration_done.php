...
$sql = "SELECT * FROM `t_user` WHERE `temppass`=?";
...
// 仮パスワードを削除する
$sql = "UPDATE `t_user` SET afg = 2 ,temppass = null ";
$sql .= "WHERE user_id ='{$val[0]['user_id']}'";
$stmt->query($sql);
...
$view -> screenView('user_registration_done');
